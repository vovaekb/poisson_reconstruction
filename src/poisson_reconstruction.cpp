...
{
    // pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_smoothed_normals = common_pcl::computeNormals(point_cloud, normalKSearch, true); 
    ...
    PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_smoothed_normals(new PointCloud<pcl::PointXYZRGBNormal>());
